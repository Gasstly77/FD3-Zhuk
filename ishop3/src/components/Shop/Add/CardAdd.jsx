...
class CardAdd extends React.Component {
    ...
    saveNewProduct = () => {
        this.validate;
        this.props.cbAddProduct({productname:this.state.currName, price:this.state.currPrice, count:this.state.currCount, url:this.state.currUrl})
    };
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="button" disabled={!this.state.valid || this.state.currName.length<1} value="Сохранить" onClick={this.saveNewProduct} />
                        </td>
                        <td>
